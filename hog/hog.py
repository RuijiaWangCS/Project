...
def roll_dice(num_rolls, dice=make_test_dice):
...
def is_swap(score0, score1):
    ...
    if score0 == 0 or score1 ==0 or score0 == 1 or score1 ==1:
        return False
    elif score0/score1 == score0//score1 or score1/score0 == score1//score0:
        return True
    else:
        return False
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if player == 0:
            ...
            if times == 0:
                score0 = score0 + take_turn(0, score1, dice)
            else:
                score0 = score0 + take_turn(times, score1, dice)
        else:
            times = strategy1(score1, score0)
            if times == 0:
                score1 = score1 + take_turn(0, score0, dice)
            else:
                score1 = score1 + take_turn(times, score0, dice)
        ...
        if score > previous_score:
            ...
            if difference > previous_high:
                if difference == 1:
                    ...
                    print("%d points! That's the biggest gain yet for Player %d" % (difference, who))
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while i < 11:
        n1 = 0
        sum= 0
        work = make_averaged(roll_dice, num_samples)
        average = work(i, dice)
        if average > max:
            max = average
            num = i
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if score < opponent_score:
        afterscore = score + free_bacon(opponent_score)
        if is_swap(afterscore, opponent_score):
            return 0
        if free_bacon(opponent_score) >= margin:
            return 0
    else:
